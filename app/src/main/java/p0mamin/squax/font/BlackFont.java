...
public class BlackFont {
    ...
    private void setDigit(){
        digit[0] = new Texture(R.drawable.zeroblack);
        digit[1] = new Texture(R.drawable.oneblack);
        digit[2] = new Texture(R.drawable.twoblack);
        digit[3] = new Texture(R.drawable.treeblack);
        digit[4] = new Texture(R.drawable.fourblack);
        digit[5] = new Texture(R.drawable.fiveblack);
        digit[6] = new Texture(R.drawable.sixblack);
        digit[7] = new Texture(R.drawable.sevenblack);
        digit[8] = new Texture(R.drawable.eightblack);
        digit[9] = new Texture(R.drawable.nineblack);
    }
}
